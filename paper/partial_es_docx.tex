...
\title{Redes Convolucionales Cuánticas frente a Clásicas para la\\
Segmentación de Subregiones del Tronco Encefálico en la Ataxia\\
Espinocerebelosa Tipo~2: Un Estudio Comparativo con Parámetros Equiparados}
\titlerunning{Redes Cuánticas vs Clásicas para Segmentación del Tronco Encefálico (SCA2)}

\author{\todo{Autor Uno}\inst{1} \and
\todo{Autor Dos}\inst{1} \and
\todo{Autor Senior}\inst{1}}
...
\emph{ATXN2}~[15]. Su neuropatología se centra en el sistema
...
progresión~[16]. La SCA2 reviste especial importancia en Cuba, donde
...
trayectoria~[16]. La delineación automática y fiable de las
...
Las U-Nets convolucionales profundas~[1,2] son la herramienta
...
aproximadores de funciones eficientes en parámetros~[10], aunque su
...
Helsinki}~[17]; el estudio fue aprobado por el
...
corrección de campo de sesgo N4~[13], registro afín al espacio MNI y
...
doble convolución~[1,2], \textbf{CerebNet}~[4] (bloques
densos competitivos), \textbf{MipaimUNet} (inception multi-rama~[8]
con conexiones de salto refinadas por atención),
\textbf{SwinUNETR}~[6,7] (autoatención por ventanas),
\textbf{ACAPULCO}~[5] (residual con preactivación) y \textbf{MARIN}
(bloques multiescala de preactivación con dilatación dual y atención
CBAM~[9])--- y tres modelos híbridos cuántico--clásicos.

\paragraph{Modelos híbridos cuánticos.} \textbf{PennyLane-QCNN}~[11]
y \textbf{Qiskit-QCNN}~[12] son U-Nets clásicas cuyo cuello de botella
se modula mediante un circuito cuántico variacional~[10]: el mapa de
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig_arch_es-1.png}
...
Los modelos se entrenaron con Adam~[14] (tasa~$10^{-3}$, programación
coseno, calentamiento de $5$ épocas), una pérdida combinada de entropía cruzada
y Dice suave~[3] con ponderación de clases por frecuencia inversa,
